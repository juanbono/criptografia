...
{-
key[16] = { 0x00 0x01 0x02 0x03
            0x04 0x05 0x06 0x07
            0x08 0x09 0x0a 0x0b
            0x0c 0x0d 0x0e 0x0f }

iv[16] = { 0xf0 0xe0 0xd0 0xc0
           0xb0 0xa0 0x90 0x80
           0x70 0x60 0x50 0x40
           0x30 0x20 0x10 0x00 }
-}
...
stateAfterKeyInput = IState (U.fromList [a0, a1, a2]) emptyBuffer
  where
    a0 = 0x01020304050607
...
stateAfterMix = IState
  (U.fromList [0x7dea261cb61d4fea, 0xeafb528479bb687d, 0xeb8189612089ff0b])
  (U.fromList bs)
  where
...
stateAfterIVInput = IState
  (U.fromList [0x8d0af6dc06bddf6a, 0x9a9b02c4499b787d, 0xf100cffe031d365b])
  (U.fromList bs)
  where
  bs = [ 0x7dea261cb61d4fea, 0xbfe2485ac2696cc7, 0xc905d08f50fa71db, 0xfd5755df9cc0ceb9
       , 0x5cc4835080bc5321, 0xdfbbb88c02c9c80a, 0x591a6857e3112cee, 0x20ead0479e63cdc3
...
stateAfterSecondMixing = IState
  (U.fromList [0x4e466dffcb92db48, 0xf5eb67b928359d8b, 0x5d3c31a0af9cd78f])
  (U.fromList bs)
  where
  bs = [ 0x7dea261cb61d4fea, 0xbfe2485ac2696cc7, 0xc905d08f50fa71db, 0xfd5755df9cc0ceb9
       , 0x5cc4835080bc5321, 0xdfbbb88c02c9c80a, 0x591a6857e3112cee, 0x20ead0479e63cdc3
...
stateAfterInit = IState
  (U.fromList [0x0ce5a4d1a0cbc0f7, 0x316993816117e50f, 0xbc62430614b79b71])
  (U.fromList bs)
  where
...
initUnitTests
  ...
  v4 = IState (stateA . mixing $ v3) (stateB v3)
  v5 = thirdStep v4
